...
//"C:/Users/mainframe/Documents/Processing/libraries/nyar4psg/patternMaker/examples/ARToolKit_Patterns";


String patternPath = "C:\\Users\\awajed\\Desktop\\OOP\\MBAR2_Light\\data\\ARToolKit_Patterns";
...
//GSCapture cam;  // this has been changed from MBAR2 to make the code lightweight
Capture cam;
MultiMarker nya;
...
void setup() {
  ...
  if (cameras.length == 0) {
    ...
    // choose the camera number according to the resolution of your PC
    // number 49 in my code represents 640x480 at 30 fps = frames per second 
...
void drawMountains() {
  ...
  lights();
  // for all the markers...
  for (int i=0; i < numMarkers; i++) {// if the marker does NOT exist (the ! exlamation mark negates it)...
