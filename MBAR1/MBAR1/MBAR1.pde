...
String patternPath = "C:\\Users\\awajed\\Desktop\\OOP\\MBAR1\\data\\ARToolKit_Patterns";
...
void setup() {
  //1280, 720,
  size(800,600,OPENGL); // the sketch will resize correctly, so for example setting it to 1920 x 1080 will work as well
